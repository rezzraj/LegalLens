...
See a quick video demo-  [YT link (20 sec demo)](https://www.youtube.com/watch?v=qHVS_Av24Hw&list=PLxi7oBxXioe8Y-6NwhUHNSblNTRE92fCe)
...
---
### the model could not be deplaoyed due to huge size and gpu requirements and requires paid platform for hosting, run it from setup at the end (It USES LOCAL LLM)
